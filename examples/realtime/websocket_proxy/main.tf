...
resource "azurerm_linux_function_app" "function_app" {
  ...
  app_settings = {
    ...
    WebPubSubConnectionString      = "Endpoint=https://${azurerm_web_pubsub.wps.hostname};AccessKey=replace-me;Version=1.0;"
    WEBPUBSUB_HUB_NAME             = "realtime-proxy"
  }
}
