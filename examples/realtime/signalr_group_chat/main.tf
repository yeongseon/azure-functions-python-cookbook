...
resource "azurerm_linux_function_app" "function_app" {
  ...
  app_settings = {
    ...
    AzureSignalRConnectionString   = "Endpoint=https://${var.base_name}-signalr.service.signalr.net;AccessKey=replace-me;Version=1.0;"
    SIGNALR_HUB_NAME               = "groupchat"
  }
}
